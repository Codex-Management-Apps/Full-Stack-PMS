...
import { handleReload, setCurrentDate } from "@/lib/utils"
...
export function AddEmployeeForm(){
    ...
    const handleSubmit = (data: z.infer<typeof addEmpSchema>) => {
        ...
        const employeeData = {
            ...data,
            last_update: setCurrentDate() // Add the last_update property with the current date and time
        };
        toast({
            variant: "default",
    ...
    <Form {...form}>
        <form 
            ...
            <div className="grid gap-4 py-4">
                ...
                <div className="grid grid-cols-4 items-center gap-4">
                    <Label htmlFor="addressline" className="text-right"> Address Line </Label>
                    <div className=" col-span-3">
                        <FormField
